...
var tableSpecs = []struct {
	...
	{name: "customer_command_bindings", where: "workspace_id=$1", direct: true},
	{name: "customer_command_invocations", where: "workspace_id=$1", direct: true},
...
var nullableMemberFields = map[string][]string{
	...
	"customer_command_bindings": {"created_by"},
...
var requiredMemberRows = map[string]string{
	...
	"customer_command_invocations": "member_id",
}
