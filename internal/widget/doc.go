// Package widget owns embeddable widget configuration and its public bootstrap.
//
// # Responsibilities
//
// Widget CRUD, appearance and behaviour settings, domain allowlists, config versioning, and the public config endpoint.
//
// # Boundary
//
// The public endpoint returns a deliberately narrowed projection — no inbox ids, no domain list, no counters. A public key must reveal nothing about the workspace.
//
