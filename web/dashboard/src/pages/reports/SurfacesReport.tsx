...
export default function SurfacesReport() {
  ...
  const widget = useAnalyticsRollups(["surfaces-report", "widget", range], "surfaces.widget.conversations_started", fromFor(range));
  const portal = useAnalyticsRollups(["surfaces-report", "portal", range], "surfaces.portal.conversations_started", fromFor(range));
  const impressions = useAnalyticsRollups(["surfaces-report", "impressions", range], "surfaces.widget.impressions", fromFor(range));
  const opens = useAnalyticsRollups(["surfaces-report", "opens", range], "surfaces.widget.opens", fromFor(range));
  const articleViews = useAnalyticsRollups(["surfaces-report", "article-views", range], "surfaces.widget.articles_viewed", fromFor(range));
