import { AreaChart, Button, Card, CardBody, EmptyState, Metric, Page, PageBody, PageHeader, Section, SegmentedControl, downloadCSV, formatCompact, formatDateTime as formatDateTimeValue, type FormatOptions } from "@hubchat/shared";
...
export default function SurfacesReport() {
  ...
  const freshness = latestComputedAt(widget.items, portal.items, impressions.items, opens.items, articleViews.items);
