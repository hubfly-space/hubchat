    ...
    try {
      ...
      if (files.length > 0 && result.opening_message_id) {
        ...
        try {
          ...
          setUploadError("The request was created, but one or more attachments could not be uploaded. You can add them from the request page.");
        } finally {
          setUploading(false);
        }
      }
