...
export default function Knowledge() {
  ...
  const articles = useInfinite<{ article: Article }>(
    ...
    (cursor, signal) => {
      const params = new URLSearchParams({ q: query, collection: collectionSlug ?? "", surface: "portal", limit: "25" });
